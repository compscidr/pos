...
# directory name where we will mount a "virtual" floppy for creating OS image
BUILDDIR = build
FLOPPYDIR = floppy

all: prep stage1 

# prepares the directory where we will mount and create our OS image filesystem
prep:
